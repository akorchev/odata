...
namespace MyApp.Controllers.CodewareDb
{
    ...
    [EnableQuery]
  [ODataRoutePrefix("odata/CodewareDb/Details")]
  public partial class DetailsController: ODataController
  {
    ...
    [HttpGet("{DetailID}")]
    public SingleResult<Detail> GetDetail(int key)
    {
        var items = this.context.Details.Where(i=>i.DetailID == key);

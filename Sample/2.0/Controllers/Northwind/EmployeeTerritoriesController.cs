...
namespace MyApp.Controllers.Northwind
{
  ...
  public partial class EmployeeTerritoriesController : Controller
  {
    ...
    [HttpGet("{EmployeeID}")]
    public SingleResult<Models.Northwind.EmployeeTerritory> GetEmployeeTerritory(int key)
    {
        var items = this.context.EmployeeTerritories.Where(i=>i.EmployeeID == key);

...
namespace MyApp.Controllers.Northwind
{
  ...
  [EnableQuery]
  [ODataRoute("odata/Northwind/CustomerCustomerDemos")]
  public partial class CustomerCustomerDemosController : Controller
  {
    ...
    [HttpGet("{CustomerID}")]
    public IActionResult GetCustomerCustomerDemo(string key)
    {
        var item = this.context.CustomerCustomerDemos.Where(i=>i.CustomerID == key).SingleOrDefault();
